...
export function RightPanel() {
    ...
    return (
        <aside className="hidden lg:flex w-80 min-h-screen flex-col border-l border-white/10 bg-white/[0.02] backdrop-blur-xl">
            <div className="sticky top-0 flex flex-col h-screen overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/10 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/20">
            {/* Daily Challenges */}
