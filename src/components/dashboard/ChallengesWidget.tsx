    ...
    return (
        <div className="bg-[#020617]/50 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
            <div className="p-4 border-b border-white/10 flex items-center justify-between">
                ...
                <span className="text-xs text-white/40">{data.filter(d => d.progress.is_completed).length} / {data.length}</span>
            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        <span className="text-xs text-yellow-400">+{item.xp_reward} XP</span>
                                    </div>
